export enum ErrorCodes {
  ...
  CHALLENGE_NOT_EXPIRED = 'CHALLENGE_NOT_EXPIRED',
...
function getDefaultMessage(code: ErrorCodes): string {
  const messages: Record<ErrorCodes, string> = {
    ...
    [ErrorCodes.CHALLENGE_NOT_EXPIRED]: 'Challenge deadline has not been reached yet.',
    [ErrorCodes.INVALID_THRESHOLD]: 'Invalid trust threshold specified.',
